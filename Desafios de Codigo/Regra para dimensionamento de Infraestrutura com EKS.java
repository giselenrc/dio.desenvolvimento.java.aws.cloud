...
public class RegrasEKS {
    public static void main(String[] args) {
        ...
        int numeroMinimoNodes = (int)Math.round((double)numeroTotalPods / podsPorNode);

        //TODO: Calcule o número mínimo de servidores necessários
        int numeroMinimoServidores = (int)Math.round((double)numeroTotalPods / podsPorServidor);
